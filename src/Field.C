...
Field::CVectorField(Grid* pGrid, Solution* pSolution, int timesteps,
               int min_t)
{
...
//		-1:			operation fail
//////////////////////////////////////////////////////////////////////////
int Field::at_phys(const VECTOR3 &pos, float t, VECTOR3& vecData)
{
    ...
    pInfo.Set(pos, interpolant, -1, -1);
    if(m_pGrid->phys_to_cell(pos, interpolant, ) == -1)
        return -1;
...
int Field::at_phys(const int fromCell,
              VECTOR3& pos,
              PointInfo& pInfo,
...
//////////////////////////////////////////////////////////////////////////
int Field::phys_coord(int i, int j, int k, VECTOR3 &pos)
{
    int xdim, ydim, zdim;
    getDimension(xdim, ydim, zdim);
    if (i<0 || j<0 || k<0 || i>=xdim || j>ydim || k>zdim)
...
// volume of a cell
//////////////////////////////////////////////////////////////////////////
float Field::volume_of_cell(int cellId)
{
...
//////////////////////////////////////////////////////////////////////////
bool Field::IsNormalized()
{
    return m_bIsNormalized;
}

void Field::NormalizeField(bool bLocal)
{
...
void Field::ScaleField(float scale)
{
  m_pSolution->Scale(scale);
}

void Field::TranslateField(VECTOR3& translate) {
...
//////////////////////////////////////////////////////////////////////////
int Field::lerp_phys_coord(int cellId,
                  CellTopoType eCellTopoType,
                  float* coeff,
                  VECTOR3& pos)
{
...
void Field::getDimension(int& xdim, int& ydim, int& zdim)
{
    m_pGrid->GetDimension(xdim, ydim, zdim);
}

void Field::GetInflowRegion(vector<VECTOR3>& inflowVerts, const float t)
{
