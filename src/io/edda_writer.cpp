...
namespace edda{
	void EddaWriter::writeEddaDataset(shared_ptr<Dataset<Real> > dataset, const string &edda_file)
	{
	...
	///// Historical non-OO function to be deprecated. Instead, use the class EddaWriter
